...
pub fn get_plugin() -> DnfInstaller {
    let metadataplugin:PluginMetaData =  PluginMetaData {
                                ...
                                subtitle                       : "LibreWolf web browser",
                                icon_name                      : "librewolf.png",
                                licenses                       : &[&["License\nLink","https://librewolf.net/license-disclaimers/"]],
                                website                        : &["WebSite","https://librewolf.net/"],
    };
   ...
   DnfInstaller::create(metadataplugin,
                         ...
                         &[
                            "pkexec dnf config-manager addrepo --from-repofile=https://repo.librewolf.net/librewolf.repo --overwrite",
                            "pkexec rpm --import https://repo.librewolf.net/pubkey.gpg",
                         ], 
                         &[],
                         Box::new([])
                         )
