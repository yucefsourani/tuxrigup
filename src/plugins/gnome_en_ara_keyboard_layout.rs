...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        // UI Labels and Text
        title: "US/ARA Keyboard Layout",
        subtitle: "Set keyboard layout to english(US)/arabic",
        ...
        install_yes_or_no_label: "Change Keyboard Layout To English(US)/Arabic?",
    ...
    CustomInstaller::create(
        ...
        &["true","gsettings set org.gnome.desktop.input-sources sources \"[(\'xkb\', \'us\'), (\'xkb\', \'ara\')]\" "], // true to force write to temp file and run with bash shell
