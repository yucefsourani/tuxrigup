...
pub fn get_plugin() -> DnfInstaller {
    let metadataplugin:PluginMetaData =  PluginMetaData {
                                ...
                                install_yes_or_no_header       : "Run Install Darktable Task",
                                install_yes_or_no_label        : "Start Install Darktable Task?",
                                remove_yes_or_no_header        : "Run Remove Darktable Task",
                                remove_yes_or_no_label         : "Start Remove Darktable Task?",
                                custom_cancel_warning_message  : None,
                                after_success_install_message  : None,
                                after_success_remove_message   : None,
                                subtitle                       : "Organize and develop images from digital cameras (Fedora RPM)",
                                icon_name                      : "darktable.png",
