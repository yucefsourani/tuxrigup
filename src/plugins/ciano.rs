...
pub fn get_plugin() -> FlatpakInstaller {
    let metadataplugin:PluginMetaData =  PluginMetaData {
                                ...
                                install_yes_or_no_header       : "Run Install Ciano Task",
                                install_yes_or_no_label        : "Start Install Ciano Task?",
                                remove_yes_or_no_header        : "Run Remove Ciano Task",
                                remove_yes_or_no_label         : "Start Remove Ciano Task?",
