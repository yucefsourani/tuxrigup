...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        subtitle: "Set keyboard layout to french/arabic",
        ...
        install_yes_or_no_label: "Change Keyboard Layout To French/Arabic?",
    ...
    CustomInstaller::create(
        ...
        &["true","gsettings set org.gnome.desktop.input-sources sources \"[(\'xkb\', \'fr\'), (\'xkb\', \'ara\')]\" "], // true to force write to temp file and run with bash shell
