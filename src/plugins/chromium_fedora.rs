...
pub fn get_plugin() -> DnfInstaller {
    let metadataplugin:PluginMetaData =  PluginMetaData {
                                ...
                                install_yes_or_no_header       : "Run Install Chromium Task",
                                install_yes_or_no_label        : "Start Install Chromium Browser Task?",
                                remove_yes_or_no_header        : "Run Remove Chromium Task",
                                remove_yes_or_no_label         : "Start Remove Chromium Browser Task?",
