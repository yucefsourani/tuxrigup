...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        // UI Labels and Text
        title: "Dnf Keepcache",
        subtitle: "Enable/Disable Dnf5 keepcache Option",
        ...
        install_yes_or_no_header: "Enable Dnf Keepcache Task",
        install_yes_or_no_label: "Enable Dnf Keepcache?",
        remove_yes_or_no_header: "Disable Dnf Keepcache Task",
        remove_yes_or_no_label: "Disable Dnf Keepcache?",
        ...
        // Metadata
        icon_name: "rpm-1-320x320.png", // Image file name in the 'images' folder
        licenses: &[],
        website: &[],
    };
    ...
    CustomInstaller::create(
        ...
        &["dnf --dump-main-config | grep keepcache |cut -f2- -d '=' | grep 1"],
        ...
        &["pkexec dnf config-manager setopt keepcache=1"],
        
        // [3] Remove Commands:
        // Commands to run when the "Remove" button is clicked.
        &["pkexec dnf config-manager setopt keepcache=0"],
