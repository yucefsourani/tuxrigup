...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        // UI Labels and Text
        title: "FR(azerty)/ARA Keyboard Layout",
        subtitle: "Set keyboard layout to french(azerty)/arabic",
        button_install_label: "Oneshot",
        button_remove_label: "Oneshot",
        button_install_running_label: "Oneshot",
        button_remove_running_label: "Oneshot",
        button_waiting_label: "",
        
        // Confirmation Dialogs
        install_yes_or_no_header: "Change Keyboard Layout",
        install_yes_or_no_label: "Change Keyboard Layout To French(azerty)/Arabic?",
        remove_yes_or_no_header: "Change Keyboard Layout",
        remove_yes_or_no_label: "Change Keyboard Layout To French(azerty)/Arabic?",
        ...
        // Metadata
        icon_name: "input-keyboard.png", // Image file name in the 'images' folder
        licenses: &[],
        website: &[],
    };
    ...
    CustomInstaller::create(
        ...
        &["true","gsettings set org.gnome.desktop.input-sources sources \"[(\'xkb\', \'fr+azerty\'), (\'xkb\', \'ara\')]\" "], // true to force write to temp file and run with bash shell
