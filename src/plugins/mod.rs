...
pub mod mpv_fedora;
pub mod natron_flatpak;
pub mod opera_fedora;
pub mod m_edge_fedora;
pub mod librewolf_fedora;
pub mod pycharmcommunity_fedora;
pub mod qbittorrent_fedora;
pub mod scratch3_flatpak;
pub mod sublime_flatpak;
pub mod tailscale_fedora;
pub mod telegram_flatpak;
pub mod teamviewer_fedora;
