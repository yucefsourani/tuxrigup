...
pub fn get_plugin() -> FlatpakInstaller {
    let metadataplugin:PluginMetaData =  PluginMetaData {
                                ...
                                install_yes_or_no_header       : "Run Install Godot Task",
                                install_yes_or_no_label        : "Start Install Godot Task?",
                                remove_yes_or_no_header        : "Run Remove Godot Task",
                                remove_yes_or_no_label         : "Start Remove Godot Task?",
                                custom_cancel_warning_message  : None,
                                after_success_install_message  : None,
                                after_success_remove_message   : None,
                                subtitle                       : "Godot Game Engine editor\n(Flatpak User Wide)",
                                icon_name                      : "godot_icon.png",
