...
pub fn get_plugin() -> DnfInstaller {
    let metadataplugin:PluginMetaData =  PluginMetaData {
                                ...
                                install_yes_or_no_header       : "Run Install XFCE Video Thumbnails Task",
                                install_yes_or_no_label        : "Start Install XFCE Video Thumbnails Task?",
                                remove_yes_or_no_header        : "Run Remove XFCE Video Thumbnails Task",
                                remove_yes_or_no_label         : "Start Remove XFCE Video Thumbnails Task?",
