...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        // UI Labels and Text
        title: "Gnome File Directories First",
        subtitle: "Enable/Disable File Directories First",
    ...
    CustomInstaller::create(
        ...
        &["gsettings get org.gtk.gtk4.Settings.FileChooser  sort-directories-first | grep true"],
