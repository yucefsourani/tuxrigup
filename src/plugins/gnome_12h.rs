...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        subtitle: "Enable/Disable 12H Time Format",
        ...
        // Metadata
        icon_name: "org.gnome.clocks.png", // Image file name in the 'images' folder
        licenses: &[],
        website: &[],
    };
    ...
    CustomInstaller::create(
        ...
        &["gsettings get org.gnome.desktop.interface clock-format |grep 12"],
