...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        subtitle: "Enable/Disable TouchPad Tap To Click",
        ...
        // Metadata
        icon_name: "input-touchpad.png", // Image file name in the 'images' folder
        licenses: &[],
        website: &[],
    };
    ...
    CustomInstaller::create(
        ...
        &["gsettings get org.gnome.desktop.peripherals.touchpad tap-to-click | grep true"],
