...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        // UI Labels and Text
        title: "Middle-click Selection Paste",
        subtitle: "Enable/Disable Middle-click Primary Selection Paste",
        ...
        // Metadata
        icon_name: "middle_click_paste.png", // Image file name in the 'images' folder
        licenses: &[],
        website: &[],
    };
    ...
    CustomInstaller::create(
        ...
        &["gsettings get org.gnome.desktop.interface gtk-enable-primary-paste | grep true"],
