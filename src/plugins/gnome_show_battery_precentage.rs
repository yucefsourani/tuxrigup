...
pub fn get_plugin() -> CustomInstaller {
    let metadataplugin: PluginMetaData = PluginMetaData {
        ...
        subtitle: "Enable/Disable Show Battery Percentage",
        ...
        // Metadata
        icon_name: "battery-full-charged.png", // Image file name in the 'images' folder
        licenses: &[],
        website: &[],
    };
    ...
    CustomInstaller::create(
        ...
        &["gsettings get org.gnome.desktop.interface show-battery-percentage |grep true"],
